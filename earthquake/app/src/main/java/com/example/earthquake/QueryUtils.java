        ...
        public static ArrayList<earthquake> extractEarthquakes() {
            ...
            try {
                ...
                for (int i = 0; i < array.length(); i++){
                    ...
                    JSONObject propertise= currentobject.getJSONObject("properties");
                    Double magnitude=propertise.getDouble("mag");
                    String place=propertise.getString("place");
                    Long tim=propertise.getLong("time");
                    String url=propertise.getString("url");



                    earthquake earthquakesss=new earthquake(magnitude,place,tim,url);
                    earthquakes.add(earthquakesss);
                }
